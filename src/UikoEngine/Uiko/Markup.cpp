// Markup.cpp: implementation of the CMarkupST class.
//
// Markup Release 9.0
// Copyright (C) 1999-2007 First Objective Software, Inc. All rights reserved
// Go to www.firstobject.com for the latest CMarkupST and EDOM documentation
...
void CMarkupST::operator=( const CMarkupST& markup )
{
...
bool CMarkupST::SetDoc( MCD_PCSZ szDoc )
{
	// Set document text
	if ( szDoc )
		m_strDoc = szDoc;
...
bool CMarkupST::SetDoc( const MCD_STR& strDoc )
{
	m_strDoc = strDoc;
	MCD_STRCLEAR(m_strError);
	return x_ParseDoc();
...
bool CMarkupST::Load( MCD_CSTR szFileName )
{
...
bool CMarkupST::ReadTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
bool CMarkupST::Save( MCD_CSTR szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nFlags );
}

bool CMarkupST::WriteTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
bool CMarkupST::FindElem( MCD_CSTR szName )
{
...
bool CMarkupST::FindChildElem( MCD_CSTR szName )
{
...
MCD_STR CMarkupST::EscapeText( MCD_CSTR szText, int nFlags )
{
...
MCD_STR CMarkupST::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
int CMarkupST::UTF16To8( char* pszUTF8, const wchar_t* pwszUTF16, int nUTF8Count )
{
...
int CMarkupST::DecodeCharUTF8( const char*& pszUTF8 )
{
...
void CMarkupST::EncodeCharUTF16( int nUChar, wchar_t* pwszUTF16, int& nWideLen )
{
...
int CMarkupST::UTF8To16( wchar_t* pwszUTF16, const char* pszUTF8, int nUTF8Count )
{
...
int CMarkupST::DecodeCharUTF16( const wchar_t*& pwszUTF16 )
{
...
void CMarkupST::EncodeCharUTF8( int nUChar, char* pszUTF8, int& nUTF8Len )
{
...
#if ! defined( UNICODE )
MCD_STR CMarkupST::UTF8ToA( MCD_CSTR pszUTF8, int* pnFailed/*=NULL*/ )
{
...
MCD_STR CMarkupST::AToUTF8( MCD_CSTR pszANSI )
{
...
MCD_STR CMarkupST::GetDeclaredEncoding( MCD_CSTR szDoc )
{
...
int CMarkupST::FindNode( int nType )
{
...
MCD_STR CMarkupST::GetTagName() const
{
...
MCD_STR CMarkupST::GetAttribName( int n ) const
{
...
bool CMarkupST::SavePos( MCD_CSTR szPosName )
{
...
bool CMarkupST::RestorePos( MCD_CSTR szPosName )
{
...
bool CMarkupST::RemoveChildElem()
{
...
MCD_STR CMarkupST::x_GetLastError()
{
	MCD_STR strError;
#ifdef MCD_STRERROR
...
bool CMarkupST::x_AllocPosArray( int nNewSize /*=0*/ )
{
...
int CMarkupST::x_ParseElem( int iPosParent, TokenPos& token )
{
...
bool CMarkupST::x_FindAny( MCD_PCSZ szDoc, int& nChar )
{
...
bool CMarkupST::x_FindName( CMarkupST::TokenPos& token )
{
...
MCD_STR CMarkupST::x_GetToken( const CMarkupST::TokenPos& token )
{
...
int CMarkupST::x_FindElem( int iPosParent, int iPos, MCD_PCSZ szPath ) const
{
...
int CMarkupST::x_ParseNode( CMarkupST::TokenPos& token, CMarkupST::NodePos& node )
{
...
MCD_STR CMarkupST::x_GetPath( int iPos ) const
{
	MCD_STR strPath;
	while ( iPos )
	{
...
MCD_STR CMarkupST::x_GetTagName( int iPos ) const
{
...
bool CMarkupST::x_FindAttrib( CMarkupST::TokenPos& token, MCD_PCSZ szAttrib, int n/*=0*/ )
{
...
MCD_STR CMarkupST::x_GetAttrib( int iPos, MCD_PCSZ szAttrib ) const
{
...
bool CMarkupST::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, int nValue )
{
...
bool CMarkupST::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, MCD_PCSZ szValue )
{
...
bool CMarkupST::x_CreateNode( MCD_STR& strNode, int nNodeType, MCD_PCSZ szText )
{
...
MCD_STR CMarkupST::x_EncodeCDATASection( MCD_PCSZ szData )
{
...
bool CMarkupST::x_SetData( int iPos, int nValue )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
bool CMarkupST::x_SetData( int iPos, MCD_PCSZ szData, int nFlags )
{
...
MCD_STR CMarkupST::x_GetData( int iPos ) const
{
	if ( iPos == m_iPos && m_nNodeLength )
	{
...
MCD_STR CMarkupST::x_GetElemContent( int iPos ) const
{
...
bool CMarkupST::x_SetElemContent( MCD_PCSZ szContent )
{
...
void CMarkupST::x_DocChange( int nLeft, int nReplace, const MCD_STR& strInsert )
{
...
void CMarkupST::x_Adjust( int iPos, int nShift, bool bAfterPos /*=false*/ )
{
...
int CMarkupST::x_InsertNew( int iPosParent, int& iPosRel, CMarkupST::NodePos& node )
{
...
bool CMarkupST::x_AddElem( MCD_PCSZ szName, int nValue, int nFlags )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
bool CMarkupST::x_AddElem( MCD_PCSZ szName, MCD_PCSZ szValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
MCD_STR CMarkupST::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
bool CMarkupST::x_AddSubDoc( MCD_PCSZ szSubDoc, int nFlags )
{
...
int CMarkupST::x_RemoveElem( int iPos )
{
...
void CMarkupST::x_LinkElem( int iPosParent, int iPosBefore, int iPos )
{
...
int CMarkupST::x_UnlinkElem( int iPos )
{
...
int CMarkupST::x_ReleasePos( int iPos )
{
...
int CMarkupST::x_ReleaseSubDoc( int iPos )
{
...
void CMarkupST::x_CheckSavedPos()
{
...
void CMarkupST::x_AdjustForNode( int iPosParent, int iPos, int nShift )
{
...
bool CMarkupST::x_AddNode( int nNodeType, MCD_PCSZ szText, int nFlags )
{
...
void CMarkupST::x_RemoveNode( int iPosParent, int& iPos, int& nNodeType, int& nNodeOffset, int& nNodeLength )
{
