...
{
	s_UpdateLayeredWindow = NULL;    //Garfield 2015/7/17  DEBUG情况下WndShadow.cpp 164行 s_UpdateLayeredWindow赋值报错问题；
...
void CWndShadow::Update(HWND hParent)
{
	...
	bmi.bmiHeader.biBitCount = 32;         // four 8-bit components 位数
	bmi.bmiHeader.biCompression = BI_RGB;
	bmi.bmiHeader.biSizeImage = nShadWndWid * nShadWndHei * 4;    //图像数据的大小
